...
public class  SignLanguage {
    ...
    private String fina_text = "";
    private String current_text = "";




    SignLanguage(Button clean_button, Button add_button, TextView change_text, AssetManager assetManager, String modelPath, String labelPath, int inputSize, String classification_model, int classification_input_size) throws IOException{
        ...
        add_button.setOnClickListener(new View.OnClickListener() {
            ...
            fina_text = fina_text + current_text;
            change_text.setText(fina_text);
    ...
    public Mat recognizeImage(Mat mat_image){
        ...
        for (int i=0;i<10;i++){
            ...
            if(score_value>0.5){
                ...
                // create an array for output of interperter2
                float[][] output_clas_value= new float[1][1];

                //Predict output for byteuffer1
                interpreter2.run(byteBuffer1,output_clas_value);

                //If you want to output class value
                Log.d("SignLanguage","output_class_value:" +output_clas_value[0][0]);

                // convert the output class values to alphabets
                //Create a function get_alphabets
                String sign_val = get_alphabets(output_clas_value[0][0]);
                current_text = sign_val;


                //Use puttext to add a class name in image
                //                Input /output           text               start point        font size                        text color white
    ...
    //create a copy of a convertBitmapToByteBuffer
